...
export const Footer = () => {
  return (
    <footer className="flex items-center justify-center md:py-4  mx-4">
      <div className="relative font-jakarta max-w-screen-lg w-full bg-secondary p-8 rounded-lg shadow-md">
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-gray-700 lg:flex-row">
          <p className="text-sm text-gray-400 hover:text-primary">

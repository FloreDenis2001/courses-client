...
const HeroSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="flex items-center justify-center md:py-12 mt-20 mx-4"
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          <motion.p
            className="font-thin text-base md:text-lg lg:text-xl mb-8 text-gray-600"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: inView ? 1 : 0, x: inView ? 0 : -50 }}
          ...
          >
            ...
            <div className="flex flex-col justify-between h-full">
              <div>
                ...
                <motion.p
                  className="font-thin  mb-8 text-primary text-light text-base md:text-lg lg:text-xl text-center"
                  initial={{ opacity: 0, x: -50 }}
                  animate={{ opacity: inView ? 1 : 0, x: inView ? 0 : -50 }}
                  transition={{ duration: 0.6, delay: 0.4 }}
                  style={{ textShadow: "0 1px 3px rgba(0,0,0,0.1)" }}

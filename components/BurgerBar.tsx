...
import { faAddressBook, faBook, faGraduationCap, faHouse, faX } from "@fortawesome/free-solid-svg-icons";
     ...
     <LogoBox />
      ...
      >
        {links.map((link, index) => (
          ...
          >
            <BurgerLink icon={link.icon} url={link.url}>{link.text}</BurgerLink>
          </motion.li>
        ))}
      </motion.ul>
    </section>
